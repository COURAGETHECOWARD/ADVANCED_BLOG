...
login_manager = LoginManager()  # configure your Flask app to use Flask_Login.
login_manager.init_app(app)  # create a user_loader function.
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        # Log in and authenticate user after adding details to database. Will authenticate the user with Flask-Login
        login_user(new_user)
